...
class TextBox(BaseElement):
    ...
    def get_value(self):
        ...
        Logger.info("Method get_value in item " + self.get_name() + " " + self.get_element_type() +
                    " получил значение: " + str(value))
        return value

    def clear_field(self):
        Logger.info("Delete text in an item " + self.get_name() + self.get_element_type() + "'" +
                    self.get_name() + "'")
    ...
    def selenium_clear(self):
        self.click()
        Logger.info("Item cleaning " + self.get_name() + self.get_element_type() + "'" + self.get_name() + "'")
