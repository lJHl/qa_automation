...
class BaseElement(object):
    ...
    def find_element(self):
        ...
        element = self.wait_for_check_by_condition(method_to_check=waiter, message=" was not found")
        return element
    ...
    def send_keys_without_click(self, key):
        Logger.info("send_keys: Change text for an item '" + self.get_name() + " " + self.__class__.__name__ +
                    "'" + "' to text => '" + key + "'")
    ...
    def wait_for_clickable(self):
        ...
        return self.wait_for_check_by_condition(method_to_check=waiter, message=" not clickable")

    def wait_for_is_visible(self):
        self.wait_for_is_present()
        waiter = ec.visibility_of_element_located((self.get_search_condition(), self.get_locator()))
        self.wait_for_check_by_condition(method_to_check=waiter, message=" invisible")

    def wait_for_is_present(self):
        waiter = ec.presence_of_element_located((self.get_search_condition(), self.get_locator()))
        self.wait_for_check_by_condition(method_to_check=waiter, message=" does not exist")
    ...
    def wait_for_is_absent(self, msg=" exist"):
